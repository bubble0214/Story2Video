  ...
  return (
    <div className="container max-w-5xl mx-auto py-8 px-4 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight">歌词</h1>
        <Button variant="outline" onClick={() => router.push('/assets/lyrics')}>返回资产</Button>
      </div>
      <LyricsTab content={(result.lyrics_content as string) || '未生成歌词内容。'} />
    </div>
  );
}
